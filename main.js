...
d3.csv('color.csv', dataPreprocessor).then(function(dataset) {
    cars = dataset;
...
SplomCell.prototype.update = function(g, data) {
    ...
    var dotsEnter = dots.enter()
        ...
        .style("fill", function(d) { 
            if(_this.col == 3){
                return "hsl(200,100%,"+d.bright+"%)";
            }else if(_this.col == 1){
                return "hsl("+d.hue+",100%,50%)";
            }else if(_this.col == 2){
                return "hsl(200,"+d.sat+"%,50%)";}})
        .attr('r', 4);
